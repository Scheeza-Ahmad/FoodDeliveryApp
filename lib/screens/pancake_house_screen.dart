...
import 'package:food/models/pancake_popular_model.dart';
...
class PancakeHouseScreen extends StatelessWidget {
  const PancakeHouseScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final CartController cartController = Get.find();
    final ResturantMenuController menuController = Get.put(
      ResturantMenuController(PancakePopularModel.popular),
      tag: 'pancake_house',
    );
                                  ...
                                  SizedBox(
                                    ...
                                    child: Obx(
                                      () => ListView.builder(
                                        ...
                                        itemCount:
                                            menuController.filteredItems.length,
                                        itemBuilder: (context, index) {
                                          var item = menuController
                                              .filteredItems[index];
                                          return Card(
                                            elevation: 4,
