...
import 'package:food/models/layers_popular_model.dart';
...
class LayersResturantScreen extends StatelessWidget {
  const LayersResturantScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final CartController cartController = Get.find();
    final ResturantMenuController menuController = Get.put(
      ResturantMenuController(LayersPopularModel.popular),
      tag: 'layers_tag',
    );
            ...
            builder: (context, constraints) {
              return SingleChildScrollView(
                padding: EdgeInsets.only(
                  bottom: MediaQuery.of(context).viewInsets.bottom, // 👈 adjust karega keyboard space
                ),
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Icon(Icons.restaurant_menu_sharp, color: Colorutil.color),
